...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6351399b05e0c6_69439569',
...
function content_6351399b05e0c6_69439569 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="zagolovok">
        ООО «ТД «АНМАКС»
 </div>
       ...
       <tbody>
           <tr class="draw_inn">
             ...
             <td width="32">
             <a href="?transition=10&id=3649&inn=7727830864&typeQuery=309#win309"><img src ="icons/table/plus.png"></a>
             </td>
             <td>Емайл</td>
             <td width="32">
             <a href="?transition=10&id=3649&inn=7727830864&typeQuery=409#win409"><img src ="icons/table/plus.png"></a>
             </td>
          ...
          <tr class="draw_inn">
             <td class = "inntext" >7727830864</td>
...
<table width ="100%" class ="telephone">
                                                       ...
                                                       <tr>
       <td width ="20">
       <a class="link_tel" itemprop="telephone" href="tel:++7(234) 245-34-53">
       <img style = "opacity: 0.9" src="icons/table/telephone.png">
        ...
        <td width="80" title="" class ="">
         ...
         <!-- WhatsApp -->
          ...
          <a rel="nofollow" href="https://web.whatsapp.com/send?phone=+7(234) 245-34-53" target="_blank">
    ...
    <a href="?transition=10&id=3649&id_phone=4694&typeQuery=300#win300" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
              </td>
      </tr>
    ...
    <a href="?transition=10&id=3649&id_phone=4716&typeQuery=300#win300" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
              </td>
      </tr>

                                                       <tr>
       <td width ="20">
       <a class="link_tel" itemprop="telephone" href="tel:+7 (533) 333-33-45">
       <img style = "opacity: 0.9" src="icons/table/telephone.png">
       </a>
       </td>
        ...
        <td width="80" title="" class ="new_phone_number">
         ...
         <!-- WhatsApp -->
          ...
          <a rel="nofollow" href="https://web.whatsapp.com/send?phone=7 (533) 333-33-45" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" opacity ="0.3" viewBox="0 0 20 20"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M10.0036 0.00168721C8.21686 0.00116491 6.46263 0.479332 4.92332 1.38646C3.38401 2.29359 2.11583 3.59656 1.25065 5.15986C0.385481 6.72316 -0.0450837 8.4897 0.00373451 10.2758C0.0525527 12.0619 0.578971 13.8022 1.52825 15.316L1.76616 15.6939L0.755461 19.3824L4.54008 18.3903L4.90454 18.6063C6.4452 19.5187 8.20287 20.0001 9.99345 20H9.99851C12.6506 20.0004 15.1943 18.9473 17.0699 17.0723C18.9456 15.1972 19.9996 12.6539 20 10.0017C20.0004 7.34952 18.9473 4.80581 17.0723 2.93013C15.1973 1.05445 12.654 0.000447549 10.0019 0L10.0036 0.00168721ZM15.0176 15.2202C15.3666 14.9742 15.661 14.6587 15.8821 14.2934C16.0789 13.8444 16.1399 13.3476 16.0576 12.8643C15.9834 12.7394 15.7826 12.6668 15.4822 12.515C15.1819 12.3631 13.7021 11.6359 13.4271 11.5363C13.1521 11.4368 12.953 11.3861 12.7522 11.6865C12.5514 11.9868 11.976 12.6635 11.8005 12.8643C11.6251 13.065 11.4496 13.092 11.1493 12.9402C10.2627 12.5874 9.44445 12.0826 8.73134 11.4486C8.07412 10.841 7.51062 10.1393 7.05923 9.3664C6.88544 9.06606 7.04067 8.90407 7.19252 8.7539C7.32751 8.61891 7.49118 8.40294 7.64303 8.22745C7.76654 8.07559 7.86768 7.90683 7.94337 7.72631C7.98326 7.64338 8.00183 7.5518 7.99741 7.45988C7.99299 7.36796 7.96572 7.27859 7.91806 7.19986C7.84382 7.04969 7.24314 5.5699 6.99005 4.96921C6.74708 4.38201 6.50073 4.46132 6.31513 4.45288C6.13965 4.44276 5.93886 4.44276 5.73975 4.44276C5.58744 4.44684 5.43762 4.48237 5.29969 4.54713C5.16177 4.61188 5.03873 4.70445 4.93829 4.81903C4.59843 5.14069 4.32929 5.52961 4.14801 5.96101C3.96674 6.39242 3.8773 6.85685 3.88541 7.32473C3.98354 8.45825 4.41046 9.53846 5.11376 10.4328C6.40303 12.3647 8.17239 13.9283 10.2482 14.97C10.8076 15.2115 11.3792 15.4232 11.9608 15.6045C12.5741 15.7905 13.2223 15.8309 13.854 15.7226C14.2724 15.6372 14.6685 15.4661 15.0176 15.2202Z"
    ...
    <a href="?transition=10&id=3649&id_phone=4717&typeQuery=300#win300" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
              </td>
      </tr>
                                       ...
                                       <tr>
       <td width ="20">
       <a class="link_tel" itemprop="telephone" href="tel:+7 (567) 856-78-56">
       <img style = "opacity: 0.9" src="icons/table/telephone.png">
       </a>
       </td>

        <td width="80" title="гкенгкегн" class ="actual_phone_number">
         7 (567) 856-78-56
         </td>
         ...
         <!-- WhatsApp -->
          ...
          <a rel="nofollow" href="https://web.whatsapp.com/send?phone=7 (567) 856-78-56" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" opacity ="0.3" viewBox="0 0 20 20"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M10.0036 0.00168721C8.21686 0.00116491 6.46263 0.479332 4.92332 1.38646C3.38401 2.29359 2.11583 3.59656 1.25065 5.15986C0.385481 6.72316 -0.0450837 8.4897 0.00373451 10.2758C0.0525527 12.0619 0.578971 13.8022 1.52825 15.316L1.76616 15.6939L0.755461 19.3824L4.54008 18.3903L4.90454 18.6063C6.4452 19.5187 8.20287 20.0001 9.99345 20H9.99851C12.6506 20.0004 15.1943 18.9473 17.0699 17.0723C18.9456 15.1972 19.9996 12.6539 20 10.0017C20.0004 7.34952 18.9473 4.80581 17.0723 2.93013C15.1973 1.05445 12.654 0.000447549 10.0019 0L10.0036 0.00168721ZM15.0176 15.2202C15.3666 14.9742 15.661 14.6587 15.8821 14.2934C16.0789 13.8444 16.1399 13.3476 16.0576 12.8643C15.9834 12.7394 15.7826 12.6668 15.4822 12.515C15.1819 12.3631 13.7021 11.6359 13.4271 11.5363C13.1521 11.4368 12.953 11.3861 12.7522 11.6865C12.5514 11.9868 11.976 12.6635 11.8005 12.8643C11.6251 13.065 11.4496 13.092 11.1493 12.9402C10.2627 12.5874 9.44445 12.0826 8.73134 11.4486C8.07412 10.841 7.51062 10.1393 7.05923 9.3664C6.88544 9.06606 7.04067 8.90407 7.19252 8.7539C7.32751 8.61891 7.49118 8.40294 7.64303 8.22745C7.76654 8.07559 7.86768 7.90683 7.94337 7.72631C7.98326 7.64338 8.00183 7.5518 7.99741 7.45988C7.99299 7.36796 7.96572 7.27859 7.91806 7.19986C7.84382 7.04969 7.24314 5.5699 6.99005 4.96921C6.74708 4.38201 6.50073 4.46132 6.31513 4.45288C6.13965 4.44276 5.93886 4.44276 5.73975 4.44276C5.58744 4.44684 5.43762 4.48237 5.29969 4.54713C5.16177 4.61188 5.03873 4.70445 4.93829 4.81903C4.59843 5.14069 4.32929 5.52961 4.14801 5.96101C3.96674 6.39242 3.8773 6.85685 3.88541 7.32473C3.98354 8.45825 4.41046 9.53846 5.11376 10.4328C6.40303 12.3647 8.17239 13.9283 10.2482 14.97C10.8076 15.2115 11.3792 15.4232 11.9608 15.6045C12.5741 15.7905 13.2223 15.8309 13.854 15.7226C14.2724 15.6372 14.6685 15.4661 15.0176 15.2202Z"
          ...
          <!-- Контактное лицо -->
          <td width ="130">енгкен</td>

          <td width="20">
    
    <a href="?transition=10&id=3649&id_phone=4718&typeQuery=300#win300" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
              </td>
      </tr>
...
<a class = " link_tel " href="mailto:3847@iuhf.com"> 3847@iuhf.com</a>
                              ...
                              <td width="70">
                               ...
                               <td width="30">
                     <a href="?transition=10&id=3649&id_email=3461&typeQuery=400#win400" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
                               </td>
                        </tr>
 </table>
...
<a class = " link_tel " href="mailto:"> </a>
                              ...
                              <td width="70">
                               ...
                               <td width="30">
                     <a href="?transition=10&id=3649&id_email=3470&typeQuery=400#win400" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
                               </td>
                        </tr>
 </table>
...
<a class = " link_tel " href="mailto:3847@iuhf.com"> 3847@iuhf.com</a>
                              ...
                              <td width="70">
                               ...
                               <td width="30">
                     <a href="?transition=10&id=3649&id_email=3471&typeQuery=400#win400" class="btn"><img style = "opacity: 0.9" src="icons/table/change.png"></a>
                               </td>
                        </tr>
 </table>
 ...
 <!-- *********************  ВЫВОД КОНТАКТНОЕ ЛИЦО ********************* -->
             <td width ="200">Петро </td>
             <td>117042, г Москва, ул Адмирала Лазарева, д 26, помещ IIБ</td>
             <td></td>

<!-- *********************  Корректировка данных компании ********************* -->
             <td width="20">
             <a href="?id=3649&inn=<br />
<b>Notice</b>:  Undefined index: inn in <b>C:\xampp\htdocs\InfoKP\templates_c\ce1cf0ac012a181703be25134719845597c5462b_0.file.company_table.tpl.cache.php</b> on line <b>219</b><br />
<br />
<b>Notice</b>:  Trying to get property 'value' of non-object in <b>C:\xampp\htdocs\InfoKP\templates_c\ce1cf0ac012a181703be25134719845597c5462b_0.file.company_table.tpl.cache.php</b> on line <b>219</b><br />
